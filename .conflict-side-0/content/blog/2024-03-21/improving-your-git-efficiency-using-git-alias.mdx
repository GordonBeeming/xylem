...
<YouTubeEmbed title="YouTube video player" src="https://www.youtube.com/embed/ZE6ts2qtScw?si=yxcJEgHtS-jeT3PI" width="560" height="315" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="allowfullscreen" duration={845} />  
...
```powershell title="Without alias"
