      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="mb-10 grid grid-cols-1 gap-8 md:grid-cols-[2fr_1fr_1fr] md:gap-12">
          ...
          <div>
            ...
            <a href="https://tina.io" target="_blank" rel="noopener noreferrer" className="mt-2 block max-w-xs">
                <svg className="w-full h-auto" viewBox="0 0 1020 254" fill="none" xmlns="http://www.w3.org/2000/svg">
