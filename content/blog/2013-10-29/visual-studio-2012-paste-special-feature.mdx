...
```csharp title="Generated classes from JSON"
...
```csharp title="Generated classes from XML"
/// <remarks/>
...
```csharp title="Deserializing JSON objects"
