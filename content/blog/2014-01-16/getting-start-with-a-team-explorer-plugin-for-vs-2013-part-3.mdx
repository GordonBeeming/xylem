...
```csharp title="SampleTeamExplorerPage.cs"
...
```xml title="SamplePageControl.xaml"
...
```csharp title="PageContent property"
...
```csharp title="Navigate to Sample Page"
...
```csharp title="Navigate to Home Page"
