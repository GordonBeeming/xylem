...
```csharp title="SampleTeamExplorerSection.cs"
...
```xml title="SampleSectionControl.xaml"
...
```csharp title="SampleSectionControl.xaml.cs"
...
```csharp title="SectionContent property"
