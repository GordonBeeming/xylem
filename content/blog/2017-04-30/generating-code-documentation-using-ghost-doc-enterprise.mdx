...
```csharp title="Add method (before docs)"
...
```csharp title="Add method (with docs)"
/// <summary>
...
<Figure key="/images/844d7addc8f84666b9a842bf72c4482a.png" src="/images/844d7addc8f84666b9a842bf72c4482a.png" alt="Ghost Doc spell check suggesting a correction for a typo in a variable name" width="0" height="0" caption="Ghost Doc spell checker identifying a typo in a variable name and suggesting a correction." />
...
<Figure key="/images/d525ca772f624368a587e5e70e4aab39.png" src="/images/d525ca772f624368a587e5e70e4aab39.png" alt="Ghost Doc spell checker options in Visual Studio" width="0" height="0" caption="Visual Studio options dialog showing configurable spell check settings for Ghost Doc." />
...
<Figure key="/images/f724f1067b64463891b1760c289ef0c5.png" src="/images/f724f1067b64463891b1760c289ef0c5.png" alt="Command prompt window showing the directory of the solution with XML comments" width="0" height="0" caption="Command prompt window navigated to the solution directory containing XML comments." />
...
<Figure key="/images/c7dec847b890461ab6c90f611d56699c.png" src="/images/c7dec847b890461ab6c90f611d56699c.png" alt="File explorer showing the generated .chm help file in the Help folder" width="0" height="0" caption="File explorer displaying the .chm help file generated by Ghost Doc in the Help folder." />
...
<Figure key="/images/ed94c4ad3b1e4770a7969d1967cd7f51.png" src="/images/ed94c4ad3b1e4770a7969d1967cd7f51.png" alt="Generated CHM help file displaying formatted code comments" width="0" height="0" caption="The generated CHM help file, showcasing nicely formatted code documentation similar to old MSDN style." />
 
Ghost Doc generates to other formats as well as you would see on their [editions compare page](https://go.beeming.net/2pv5W6F) 🙂
 
<Figure key="/images/beb9d867b2df4f439f4b1a711c475119.png" src="/images/beb9d867b2df4f439f4b1a711c475119.png" alt="Ghost Doc editions comparison page highlighting different output formats" width="0" height="0" caption="Ghost Doc editions comparison page, indicating support for various documentation output formats." />
 
We now have a chm that we can distribute with our source 🙂.
 
## Adding this to our CI
 
Generating docs from your machine is ok but then you have to remember to do it and what's worse is that you'll have to check that file into source control (Emphasis on the **Source** in source control 🙂) which wouldn't be great. So naturally as [Donovan Brown](https://go.beeming.net/2pveWIL) reminds us "anything you can do on a command line you can do in VSTS or TFS" 😁.
 
I've gone ahead and setup a standard CI build using the built in Visual Studio template.
 
<Figure key="/images/ddcc318b92ed4abb9aea55c1fe907f3d.png" src="/images/ddcc318b92ed4abb9aea55c1fe907f3d.png" alt="VSTS/TFS build definition using the Visual Studio template" width="0" height="0" caption="VSTS/TFS build definition configured with the standard Visual Studio template." />
 
If we look at the current build artifacts you will notice that only our class library and pdb is being published
 
<Figure key="/images/2d715933b4a143c5b142091d36a3f73b.png" src="/images/2d715933b4a143c5b142091d36a3f73b.png" alt="VSTS/TFS build artifacts showing only the class library and PDB files" width="0" height="0" caption="VSTS/TFS build artifacts, currently publishing only the class library and PDB files." />
 
To add the help file to this we are going to do a couple steps. First add Command Line task 
 
<Figure key="/images/60989716f6114b3ba4e1740bfa85d408.png" src="/images/60989716f6114b3ba4e1740bfa85d408.png" alt="Adding a Command Line task to the VSTS/TFS build definition" width="0" height="0" caption="Adding a Command Line task to the VSTS/TFS build definition to generate documentation." />
    
and place it before the *Copy Files to: $(build.artifactstagingdirectory)* task
 
<Figure key="/images/60792a49269e45c2a6903168f07b5765.png" src="/images/60792a49269e45c2a6903168f07b5765.png" alt="VSTS/TFS build definition with the Command Line task placed before the Copy Files task" width="0" height="0" caption="VSTS/TFS build definition showing the Command Line task positioned before the Copy Files task." />
...
<Figure key="/images/3241e2f196a94468b8f35f497f35fdfa.png" src="/images/3241e2f196a94468b8f35f497f35fdfa.png" alt="Configuring the Command Line task in VSTS/TFS to run Ghost Doc" width="0" height="0" caption="Configuring the Command Line task in VSTS/TFS with the Ghost Doc executable path and arguments." />
 
Now add a Copy Files task
 
<Figure key="/images/d91e75e88ea44655af21f0dc38d13772.png" src="/images/d91e75e88ea44655af21f0dc38d13772.png" alt="VSTS/TFS build definition showing the addition of a Copy Files task" width="0" height="0" caption="Adding a Copy Files task to the VSTS/TFS build definition to copy the generated help file." />
 
and add this below the Command Line task
 
<Figure key="/images/8c4074093be546b3bccc29cd56a2ce95.png" src="/images/8c4074093be546b3bccc29cd56a2ce95.png" alt="VSTS/TFS build definition showing the configuration of the Copy Files task" width="0" height="0" caption="Configuring the Copy Files task in VSTS/TFS to copy the help file to the desired location." />
...
<Figure key="/images/1747cc9235b24cc0bd676239cbf7f5dd.png" src="/images/1747cc9235b24cc0bd676239cbf7f5dd.png" alt="VSTS/TFS build definition showing the final configuration of the build tasks" width="0" height="0" caption="Final configuration of the VSTS/TFS build definition showing all tasks in place." />
 
If we click Save and run this build you will notice that after the build runs we have our help file in the drop 🙂
 
<Figure key="/images/a399a692d9c74c64a6a4b13492eb69ec.png" src="/images/a399a692d9c74c64a6a4b13492eb69ec.png" alt="Build output showing the generated help file in the drop location" width="0" height="0" caption="Build output indicating the successful generation and placement of the help file." />
