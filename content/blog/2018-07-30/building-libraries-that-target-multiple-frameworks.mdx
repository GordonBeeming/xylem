...
```xml title=".csproj (multiple targets)"
<PropertyGroup>
...
```xml title="Parameterized .nuspec"
<?xml version="1.0"?>
<package xmlns="http://schemas.microsoft.com/packaging/2010/07/nuspec.xsd">
  <metadata>
    <id>TargetMultipleFrameworksForLib</id>
...
```bat title="VSTS nuget pack arguments"
...
```json title="VSTS Task Group JSON"
{
    "tasks": [
        {
