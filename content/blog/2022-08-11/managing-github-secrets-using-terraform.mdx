...
<YouTubeEmbed src="//www.youtube.com/embed/QWW6UOq8CCs" width="480" height="270" title="Managing GitHub secrets using terraform" duration={2460} />
...
```yaml title="publish.yml (connection string)"
name: publish
...
```yaml title="publish.yml (federated identity)"
name: publish
