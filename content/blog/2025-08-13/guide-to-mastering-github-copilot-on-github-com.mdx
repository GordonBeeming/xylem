...
While GitHub Copilot is busy plumbing that `readonly` flag and its associated tests through the codebase, you can be in your IDE tackling a complex business logic problem—the fun stuff! 🚀
