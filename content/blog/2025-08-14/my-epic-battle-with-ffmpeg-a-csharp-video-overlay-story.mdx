...
What followed was an intense debugging session where we navigated a minefield of bizarre failures: videos of the wrong length, overlays that were completely invisible, and cryptic errors from the depths of the FFmpeg library. It was the kind of troubleshooting that would have easily stretched over days, but instead, we had a working solution in a single evening. It all started with what I thought was an elegant solution...
