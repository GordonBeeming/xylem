...
Here's the thing nobody tells you: `TinaMarkdown` and `ReactMarkdown` are completely different beasts (especially for a none UI guy like me 😅). They both render markdown, but they have their own systems for handling custom components.
