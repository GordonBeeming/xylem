...
It doesn't know your project's specific rules (e.g., "all features start with '🚀 Feature -'"). It doesn't know your specific tech stack (e.g., "we *always* use xUnit, Testcontainers, and FluentAssertions"). And it doesn't know what it *shouldn't* do (e.g., "never suggest creating a new file, just edit existing ones").
