...
By the time I'm done writing the prompt, I could have written the code myself.
...
You can build this "virtual team" of specialists right inside your IDE using VS Code's Custom Chat Modes.

## The generalist AI problem

Your default AI chat doesn't know your project's specific rules (e.g., "all features start with '🚀 Feature -'"). It doesn't know your tech stack (e.g., "we always use xUnit, Testcontainers, and FluentAssertions"). And it doesn't know what it *shouldn't* do (e.g., "never suggest creating a new file, just edit existing ones").

This leads to "prompt fatigue" and a lot of wasted time correcting generic, often wrong suggestions.

### But what about `copilot-instructions.md`?

You might be thinking, "I'll just dump all these rules into my `copilot-instructions.md` file!"

I've been down that road, and it backfires.

That instruction file is loaded every single time you ask a question. It quickly becomes a 500-line monster. When you want to ask a simple question about a regex, the AI is wading through hundreds of lines of irrelevant context about your PBI templates, testing frameworks, and database schemas. It pollutes the prompt and makes responses worse for everyday tasks.

## The solution: a virtual team

Custom Chat Modes fix this. Instead of one giant instruction file, you create a set of specialists.
...
This one acts as a senior developer. It takes a PBI and a developer's high-level thoughts and turns them into a detailed, full-stack execution plan. Honestly this is where I find it most useful.
...
There's a practical upside to this that I didn't fully appreciate until I'd been using it for a while: onboarding. When a junior dev picks up a complex ticket, the Task Planner can walk through the architecture and produce a step-by-step plan scoped to your actual codebase. The Test Writer generates tests in the frameworks you actually use. Neither of those things happen reliably with a generic chat window.

Start with one persona - the Task Planner is probably the highest-value starting point - and go from there.
