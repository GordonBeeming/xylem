...
>
> **AGENT:**
> Thanks for the report. I'm ready to write this up as a 🐞 Bug. To make sure it's actionable, I need a bit more detail:
...
>
> **AGENT:**
> Great, thank you. I've created 🐞 **Bug - /admin/login no error on bad password (Issue #1234)** with all those details and added the 'needs-triage' label.

### 2. The "Task Planner"

This is our senior developer. It takes a PBI and a developer's high-level thoughts and turns them into a detailed, full-stack execution plan. This is the real magic. 🪄
