...
The project is on GitHub: [copilot_here](https://github.com/GordonBeeming/copilot_here). Install takes three commands and you get Copilot CLI running in a sandboxed container that keeps itself up to date. Give it a try and open an issue if something breaks.
