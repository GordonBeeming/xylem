...
Ever been deep in a coding session with an AI, like the Copilot CLI, and everything is just... *flowing*? 🌊 You're building, iterating, and solving problems.
...
Keep reading, this one's a game-changer for your AI-powered workflow. 😅

## The Context Trap: My "Tired" AI

I'm a big fan of the [Copilot CLI](https://github.com/features/copilot/cli) (which I run using my [copilot_yolo](https://gordonbeeming.com/blog/2025-10-03/taming-the-ai-my-paranoid-guide-to-running-copilot-cli-in-a-secure-docker-sandbox) alias). Lately, I've been using it with models like `claude-sonnet-4.5`.
...
But with the AI, I was asking it to start 'Task M' while still holding all the mental baggage from 'Task A' through 'Task L'. It's like trying to start a new, complex project at 4:55 PM on a Friday. You're just not going to get good results. 😫
...
The context is wiped. The "workday" is over. The AI is "fresh" and ready for a brand new, clean briefing. ☀️

(And for those times you *intentionally* want to jump back into your previous session's context, you can use native flags like `--resume` when you start your session. The point is to be *deliberate* about your context.)
...
No logging. No validation. No file logic. Just the task I asked for. 💡
