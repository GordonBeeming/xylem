...
4.  **Encourages Iteration:** The questioning technique is inspired by [Daniel Mackay's approach to efficient vibe coding](https://www.dandoescode.com/blog/efficient-vibe-coding-with-clarifying-questions). I used to ask the AI to "always ask for clarification" and "number questions," but Daniel's version works much better. His approach of asking one question at a time, waiting for answers, and using tables for multiple options creates a more natural, focused conversation that gets to the heart of the investigation faster.
