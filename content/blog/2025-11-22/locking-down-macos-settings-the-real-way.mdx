...
If they are an **Administrator**, they have `sudo` privileges. This means that with a little bit of Googling (which we know they are good at 😅), they can override or delete the restrictions we are about to set up.
