...
Picture this: you're investigating a bug with three terminal windows open - one in `/Users/me/projects/api`, one in `/Users/me/projects/frontend`, one in `/Users/me/investigations/bug-123`.

Previously, `copilot_here` mapped all of them to `/work`. Inside the container, they were indistinguishable. Which project were you in?
