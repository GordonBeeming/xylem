...
Check out the [copilot_here marketing site](http://copilot_here.gordonbeeming.com) - I put it together using `copilot_yolo` and the Gemini 3 Pro model (in preview) in just under 90 minutes while watching TV 😅.
