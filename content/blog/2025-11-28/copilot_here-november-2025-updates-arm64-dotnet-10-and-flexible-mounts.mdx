...
summary: 'November updates add native ARM64 images, .NET 10, PowerShell Core integration, Airlock network controls, host path mapping, and configurable directory mounts.'
---

November has been a busy month for [copilot_here](/projects/copilot-here). What started as a path mapping fix turned into a much bigger release than I planned.
...
2. **[.NET 10 SDK](#2-net-10-sdk)** - .NET SDK image variants
...
<Figure key="/images/copilot_here-site.png" src="/images/copilot_here-site.png" alt="A screenshot of the copilot_here marketing site." width="0" height="0" caption="The copilot_here site with installation instructions and feature details." />
