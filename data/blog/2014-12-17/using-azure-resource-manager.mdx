...
which will return you a list of every location that every resource is available in. This list as with the one above can be found as one of my GitHub Gists at "code snippet missing 😓". From the long list of locations we are just going to use West Europe for all our resources
