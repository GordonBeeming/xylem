...
As you can see I have some work that I need to do 🙂, or increase my scaling in Azure ![Open-mouthed smile](https://gordonbeeming.com/images/emoticons/open-mouthed-smile.svg).
...
Have a good idea for a new feature? Head over to the [Visual Studio User Voice](https://go.beeming.net/1N21eCA) site and add it 🙂.
