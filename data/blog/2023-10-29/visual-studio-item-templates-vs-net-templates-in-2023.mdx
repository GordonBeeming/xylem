...
<Figure key="./images/2023-10-29_23-22-44.jpg" src="./images/2023-10-29_23-22-44.jpg" alt="In Visual Studio, go to Project | Export Template..." width="0" height="0" caption="In Visual Studio, go to Project | Export Template..." />
...
<Figure key="./images/2023-10-29_23-31-13.gif" src="./images/2023-10-29_23-31-13.gif" alt="The Export Template Wizzard will guide you through the information needed to create the Item Project template" width="0" height="0" caption="The Export Template Wizzard will guide you through the information needed to create the Item Project template" />


<Figure key="./images/2023-10-29_23-33-39.jpg" src="./images/2023-10-29_23-33-39.jpg" alt="Windows Explorer will open showing you the file" width="0" height="0" caption="Windows Explorer will open showing you the file" />
...
<Figure key="./images/2023-10-29_23-43-04.jpg" src="./images/2023-10-29_23-43-04.jpg" alt="" width="0" height="0" caption="" />
...
<Figure key="./images/2023-10-30_00-39-45.jpg" src="./images/2023-10-30_00-39-45.jpg" alt="This icon is used to represent the nuget package once we publish it" width="0" height="0" caption="This icon is used to represent the nuget package once we publish it" />
...
<Figure key="./images/2023-10-30_01-59-44.jpg" src="./images/2023-10-30_01-59-44.jpg" alt="Once uploaded you will see all the information for the package, click Submit" width="0" height="0" caption="Once uploaded you will see all the information for the package, click Submit" />


<Figure key="./images/2023-10-30_02-04-28.jpg" src="./images/2023-10-30_02-04-28.jpg" alt="After clicking Submit, you will see that the page is uploaded with couple of warnings informing you that the page will take a bit to validate and index" width="0" height="0" caption="After clicking Submit, you will see that the page is uploaded with couple of warnings informing you that the page will take a bit to validate and index" />
