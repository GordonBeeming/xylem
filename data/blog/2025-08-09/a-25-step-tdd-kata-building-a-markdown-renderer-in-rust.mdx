...
The goal isn't just to finish. It's to embrace the TDD rhythm: write a failing test (Red), make it pass with the simplest code (Green), and then clean it up (Refactor). Let's get started! 🦀
...
...will produce the following satisfying HTML output. 🎉

```html
<h1>My Document</h1>
<p>This paragraph contains <strong>bold text</strong> and a link to <a href="[https://tianibeeming.com](https://tianibeeming.com)">my wife Tiani's blog</a>.</p>
<ul>
  <li>List Item 1</li>
  <li>List Item 2</li>
</ul>
