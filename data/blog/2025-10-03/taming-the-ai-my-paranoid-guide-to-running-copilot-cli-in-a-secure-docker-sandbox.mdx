...
* ✅ **Cognitive Ease:** I want to *feel* safe enough to let it do its job, even if that means letting it run commands automatically.
...
This will download the script and configure your PowerShell profile automatically.
...
- Information about image variants (base, .NET, .NET + Playwright, Rust, and more)
- Advanced configuration options including Airlock network isolation
