...
1. **[Native ARM64 Support](#1-native-arm64-support-apple-silicon--raspberry-pi)** - fast, native performance on Mac and ARM devices
...
6. **[Default Image Config](#6-default-image-configuration-pin-your-version)** - Lock your team to a specific image version
