...
4. **[Actual Path Mapping](#4-actual-path-mapping-know-where-you-are)** - Container paths match your host paths
5. **[Flexible Directory Mounts](#5-flexible-directory-mounts-access-what-you-need)** - Mount additional directories with granular control
6. **[Smart Window Titles](#6-smart-window-titles-cleaner-terminal-tabs)** - Auto-updating titles with mode indicators
7. **[Default Image Config](#7-default-image-configuration-variants--pinning)** - Lock your team to a specific image version
8. **[Auto-Update Checks](#8-auto-update-checks-stay-current)** - Get notified when new features land
...
## 4. Actual Path Mapping: Know Where You Are
...
## 5. Flexible Directory Mounts: Access What You Need
...
## 6. Smart Window Titles: Cleaner Terminal Tabs
...
## 7. Default Image Configuration: Variants & Pinning
...
## 8. Auto-Update Checks: Stay Current
