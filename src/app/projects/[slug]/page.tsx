  ...
  return (
    <div className="page">
      ...
      <div className="mt-[var(--space-6)] flex items-start justify-between gap-4">
        ...
        {typeof enriched.githubStars === "number" && <StarCount n={enriched.githubStars} />}
      </div>
      ...
      {enriched.video && (
        <div className="mt-[var(--space-5)]">
          <ProjectVideo url={enriched.video} title={enriched.title} />
        </div>
      )}
      ...
      <div className="mt-[var(--space-5)] flex flex-wrap items-center justify-between gap-3">
        <div className="flex flex-wrap items-center gap-1.5">
          {enriched.status && (
            <Badge tone={enriched.status.trim().toLowerCase() === "deprecated" ? "warning" : "accent"}>
              {enriched.status}
            </Badge>
          )}
        ...
        <div className="-mr-2 flex items-center gap-0.5">
          {enriched.github && (
            <IconLink href={enriched.github} label="GitHub repository">
          ...
          {enriched.href && enriched.href !== enriched.github && (
            <IconLink href={enriched.href} label="Website">
          ...
          {enriched.appStore && (
            <IconLink href={enriched.appStore} label="App Store">
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden="true">
