      ...
      <div className="site-foot-inner">
        <div className="site-foot-top">
          <div style={{ maxWidth: 360 }}>
            ...
            <p style={{ margin: "14px 0 0", fontSize: "var(--text-sm)", lineHeight: "var(--lh-relaxed)", color: "var(--text-muted)" }}>
            ...
            <a
              ...
              style={{ display: "block", maxWidth: 132, marginTop: 8 }}
              aria-label="TinaCMS"
            >
              <svg viewBox="0 0 1020 254" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", height: "auto", display: "block" }}>
